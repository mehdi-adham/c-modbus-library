...
static unsigned char COIL_MEM[MAX_COIL / 8] /* start for test */ = {0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1, 0x81, 0x40, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1, 0x81, 0x40, 0x00, 0xC1,
                                                                    0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0,
                                                                    0x80, 0x41, 0x01, 0xC0}; /* end for test */

static unsigned char INPUT_MEM[MAX_INPUT / 8] /* start for test */ = {0x00,
                                                                      ...
                                                                      0xC1, 0x81, 0x40, 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00,
                                                                      0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80, 0x41, 0x00,
                                                                      0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1}; /* end for test */
    ...
    unsigned char *RequestFrame, unsigned char *Constructed_ResponseFrame)
{
    ...
    {
        HOLDING_REGISTERS_MEM[registers_counter++] =
            RequestFrame[Byte_Counter++] << 8 | RequestFrame[Byte_Counter++];
    }
